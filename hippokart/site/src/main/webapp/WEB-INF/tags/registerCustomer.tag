...
<div class="span6 no_margin_left">
    ...
    <div class="control-group <c:if test="${not empty form.message['firstname']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input01" name="firstname"
    ...
    <div class="control-group <c:if test="${not empty form.message['lastname']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input02" name="lastname"
    ...
    <div class="control-group <c:if test="${not empty form.message['primarytelephone']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input11" name="primarytelephone"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" id="input12" name="othertelephone"
...
<div class="span6 ">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" id="input04" name="companyname"
    ...
    <div class="control-group <c:if test="${not empty form.message['streetaddress']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input05" name="streetaddress"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" id="input06" name="suburb"
    ...
    <div class="control-group <c:if test="${not empty form.message['postalcode']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input07" name="postalcode"
    ...
    <div class="control-group <c:if test="${not empty form.message['city']}">error</c:if>">
        ...
        <div class="controls">
            <input type="text" class="input-large highlight required" id="input08" name="city"
    ...
    <div class="control-group <c:if test="${not empty form.message['stateprovince']}">error</c:if>">
        <label id="StateDropDownLabel" class="control-label" for="StateDropDown"><fmt:message
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" id="input13" name="faxnumber"
...
<div class="span12 no_margin_left">
    ...
    <div class="span6 no_margin_left">
        <div class="control-group <c:if test="${not empty form.message['email']}">error</c:if>">
            ...
            <div class="controls">
                <input type="text" class="input-large highlight required email" id="input03" name="email"
    ...
    <div class="span6">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" class="input-large highlight required" id="input14" name="password">
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" class="input-large highlight required" equalTo="#input14" id="input15"
...
<div class="span6  no_margin_left">
    <legend>Custom Customer Attributes (max 5)</legend>
    <div class="span6 no_margin_left">
        <div class="control-group">
            <label class="control-label" for="input16">Custom 1</label>
            <div class="controls">
                <input type="text" class="input-large" id="input16" name="customCustomer1"
                       value="${form.value['customCustomer1'].value}">
            </div>
        </div>
    </div>
</div>
...
<div class="span6">
    <legend>Custom Address Attributes (max 5)</legend>
    <div class="span6 no_margin_left">
        <div class="control-group">
            <label class="control-label" for="input17">Custom 1</label>
            <div class="controls">
                <input type="text" class="input-large" id="input17" name="customAddress1"
                       value="${form.value['customAddress1'].value}">
            </div>
        </div>
    </div>
</div>
...
<div class=" span12 no_margin_left">
    ...
    <div class="span8">
        <div class="control-group">
            <div class="controls no_margin_left">
                <label class="checkbox">
                    <input type="checkbox" class="required" name="optionsCheckboxList1">
