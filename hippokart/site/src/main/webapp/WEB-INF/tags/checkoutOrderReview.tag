...
<form action="${orderReviewLink}" method="post">
    ...
    <table class="table table-bordered table-striped">
        ...
        <c:forEach var="item" items="${checkoutOrder.orderProducts}" varStatus="rowCounter">
            <tr class="productListing-even">
                ...
                <td align="muted center_text"valign="top">
                    <kk:formatPrice price="${item.price}"/>
                </td>
                <td align="muted center_text" class="productListing-data" valign="top">
                    ${item.quantity}
                </td>
                <td align="muted center_text" class="productListing-data" valign="top">
                    <c:choose>
    ...
    <a class="btn btn-primary" href="${editCartLink}">Edit your Cart</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="submit" class="btn btn-danger pull-right" value="Place Order"/>
</form>
